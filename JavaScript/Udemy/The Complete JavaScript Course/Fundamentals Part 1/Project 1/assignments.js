...
/* COMMENTED OUT BC WON'T WORK IN CLOUD 9
...
if (language === "English" && population <= 50000000 && !isIsland) {
    console.log("Sarah should stay in " + country + "!");
} else {
...
population > 30000000 ? console.log(country + "'s population is above average."): console.log(country + "'s is below average");